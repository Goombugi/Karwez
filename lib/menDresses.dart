...
class MenDresses extends StatefulWidget {
  @override
  _MenDressesState createState() => _MenDressesState();
}

class _MenDressesState extends State<MenDresses> {
  @override
            ...
            child: Column(
                children: [
                  ...
                  GridView.count(
                    ...
                    shrinkWrap: true,
                    children: [
                      _buildShoppingCard('رياضيه', 'سعت قشرة', 'assets/short23.jpg', 1300, 09122, 1),
                      _buildShoppingCard('بدل', ' شارع الدكاترة ', 'assets/short115.jpeg', 3500, 0121, 4),
                      _buildShoppingCard('قميص', 'شارع الدكاتره', 'assets/short2.jpg', 1000, 09909, 3),
                      _buildShoppingCard(' جلابيه الوالي', 'شارع المطار', 'assets/jlabia4.jpg', 1500, 0993, 2),
                      _buildShoppingCard(' جلابيه الوالي', 'شارع المطار ', 'assets/jlabia7.jpg', 3000, 09144, 5),
                      _buildShoppingCard('بدل', ' شارع الدكاترة ', 'assets/short19.jpg', 3500, 0121, 6),
                    ],
                  ),
                ]
            ),
