            ...
            child: Column(
                children: [
                  ...
                  GridView.count(
                    ...
                    shrinkWrap: true,
                    children: [
                      _buildShoppingCard('ميلوباك', 'صيدلية الام', 'assets/10drug.jpg', 1300, 09122, 1),
                      _buildShoppingCard('Erectalis20', ' صيدلية الموده ', 'assets/9drug.jpg', 3500, 0121, 2),
                      _buildShoppingCard('Bisoprolol STADA 5mg', 'صيدلية الرحمه', 'assets/8drug.jpg', 1000, 09909, 3),
                      _buildShoppingCard('Diane 35', 'الامدادات الطبيه', 'assets/1drug.jpg', 1500, 0993, 4),
                      _buildShoppingCard('TRIVIT-B', 'صيدلية محمد سعيد ', 'assets/6drug.jpg', 3000, 09144, 5),
                      _buildShoppingCard('Spinraza', 'صيدلية محمد سعيد ', 'assets/7drug.jpg', 3000, 09144, 5),
